...
// ⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈
//▮Dark Bot Inc 2022 ®️ALL RIGHTS RESERVED
//▮
...
const reply = (teks) => {
            ZimBotInc.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botname}`,"body": `𝗛𝗮𝗰𝗸𝗲𝗿 𝗕𝗼𝘆•💙🥀`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./Zimbot/drips.jpg`),"sourceUrl": `https://wa.me/+923474187615`}}}, { quoted: m})
        }
//dokumen random
...
break
	    ...
	    if (isBan) throw mess.ban
                ZimBotInc.sendMessage(m.chat, { image: { url: 'https://i.ibb.co/nDJYqRy/c9fe14349c05abcc90d36093f111d946.jpg' }, caption: `*Hi Chomie ${m.pushName}*\n\n *Thanks for your support we appreciate you we dont need your money,* *ASIF KHAN:* https://wa.me/+923474187615` }, { quoted: m })
            }
            break            
            case 'chat': {
                if (!isCreator) throw mess.owner
